...
The first horizontal "stripe" tells us what *attribute* (or variable) we are trying to predict. 
...
The key thing about the number stripe is that it considers only the people
...
To learn how to make a tree, see [the page about learning to drive](20-arbor-begin.qmd).
