...
This builds directly on the [n-dice chapter](#n-dice-chapter),
...
give the function a dood name, such as
...
But when you do, the actual program becomes amazingly simple and understandable.
...
So the block window will have two things in it: the function definition (which is long and details)
and the program that call it (which is short and more general).
